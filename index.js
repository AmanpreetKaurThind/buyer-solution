...
app.get('/api/supported', async (req, res) => {
    try {
        const response = await axios.get('http://45.140.188.129:6536/api/adlinks/supported');
...
app.get('/api/bypass', async (req, res) => {
  try {
    ...
    const response = await axios.get(`http://45.140.188.129:6536/api/adlinks/bypass?url=${link}`);
